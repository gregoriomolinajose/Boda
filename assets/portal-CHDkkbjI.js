import"./Firebase-C_lFSCaV.js";import{A as d}from"./Auth-BW2TVjAm.js";import"./config.js_v_2.0-DMxjU1_X.js";import{S as m}from"./Store-CWFmnUC2.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js";let c=null,i=[],r="active";d.waitForAuthInit().then(()=>{d.onSessionChange(e=>{e?(c=e,v(e.uid)):(window.Utils.showToast("Acceso denegado: redireccionando a login.","error"),setTimeout(()=>window.location.href="login.html",1500))})});window.handleLogout=()=>d.logout();async function v(e){i=await m.getEvents(e),s()}function s(){const e=document.getElementById("event-grid"),n=i.filter(t=>r==="active"?!t.archived:t.archived);if(n.length===0){e.innerHTML=r==="active"?`
